      ...
      <main className="font-medium">
        <div className="max-w-5xl space-y-10">
            <section id="introduction" className="space-y-6">
                ...
                <p>
                    A collection of pre-built pages and UI components built with <strong className="font-semibold"><a className="underline" href="https://react.dev" target="_blank">React</a></strong>,{' '}
                    <strong className="font-semibold"><a href="https://tailwindcss.com" target="_blank" className="underline">Tailwind CSS</a></strong>, and <strong className="font-semibold"><a href="https://ui.shadcn.com" target="_blank" className="underline">Shadcn/ui</a></strong>, designed to help you build
                    modern applications faster.
                </p>
                <br />
                <p>
                    This project includes customizable <strong className="font-semibold">authentication pages</strong>,{' '}
                    <strong className="font-semibold">landing sections</strong>, <strong className="font-semibold">UI components</strong>, and more — ready to copy,
                    paste, and extend directly in your project.
                </p>
                <br />
                <p>
                    Just like Shadcn/ui, <strong className="font-semibold">this is not a traditional component library</strong>.<br />
                </p>
                </div>
            </section>
            ...
            <section className="space-y-4">
                ...
                <ul className="space-y-3 list-disc pl-5 marker:text-gray-400 dark:marker:text-gray-500">
            ...
            <section className="space-y-4">
                ...
                <ul className="space-y-3 list-disc pl-5 marker:text-gray-400 dark:marker:text-gray-500">
                <li className="pl-2">Copy-paste directly into your app — no installation or version mismatch</li>
        ...
        <div className="mt-16" id="faqs">
            ...
            <div className="space-y-1 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div key={idx} className="pt-8 first:pt-0">
                    ...
                    <p className="dark:text-white/80 text-black/80 font-normal">
                    {faq.answer}
                    </p>
                </div>
                ))}
