export const featue1Code = `import Spline from "@splinetool/react-spline/next";
...
`;
export const featue1Example = `import { Feature1 } from "@/components/features/feature-1";
...
export const featue2Code = ``;
export const featue2Example = ``;

export const featue3Code = ``;
export const featue3Example = ``;
