...
export default function DocsLayout({ children, sections }: DocsLayoutProps) {
  ...
  return (
    <div className="flex min-h-screen justify-between">
      <main className="prose dark:prose-invert flex w-full items-center justify-center sm:max-w-[100%] md:max-w-xl lg:max-w-5xl pl-10">
        {children}
      </main>
      <nav className="top-30 sticky h-[100vh] hidden flex-col border-gray-200 p-4 2xl:flex dark:border-gray-700">
